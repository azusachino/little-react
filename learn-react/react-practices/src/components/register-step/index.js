...
class WizardSample extends React.Component {
  ...
  handleBack = () => {
    console.log("form values: ", this.formRef.current.getFieldsValue());
    this.setState({
      allValues: {
        ...this.state.allValues,
        ...this.formRef.current.getFieldsValue(),
  ...
  renderComponent = () => {
    ...
    return (
      <StepComponent form={this.formRef.current} allValues={this.state.allValues}/>
    );
  };
