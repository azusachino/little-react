      ...
      <View className='feed-item'>
        <View className='feed-source'>
          ...
          <View className='flex8'>
            <Text className='feed-source-text'>{this.props.feedSourceName}{this.props.feedSourceTxt}</Text>
          </View>
          ...
          <View className='answer-body'>
            <View>
              <Text className='answer-txt'
                    onClick={this.navigateTo.bind(this, '/pages/answer/answer')}>{this.props.answerCtnt}</Text>
            </View>
